...
- The version is one number across the product: `AppVersion` in `internal/app/app.go`, `MARKETING_VERSION` in `ios/Bagholder.xcodeproj/project.pbxproj`, `versionName` in `android/app/build.gradle.kts`.
