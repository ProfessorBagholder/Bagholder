...
- **Every definition is checked against how the leading journals and the industry do it, with sources**, before it is recommended or planned; every new plan carries that section, enforced by `rust/crates/core/tests/plans.rs`. (Owner.)
