...
- **Company ex-dates before 2024-05-27** are left out (Right to refuse); the planned fix reads the exchange's sessions from the stored closes of XIC, the Composite's tracker (the index levels are no longer read: `docs/plans/stage-3a-brief-06.md`).
